...
import {renderAll, getHoursAndMinutes, makeActivatingFunc, getDayMonthYear} from '../../util.js';
import {DEFAULT_POSTER, ActiveClasses} from '../../setup.js';


const makeButtonActive = makeActivatingFunc(ActiveClasses.POPUP);

const getGenre = (genre) => `<span class="film-details__genre">${genre}</span>`;

export const createFilmPopup = ({
  id, comments,
  film_info: {title, alternative_title, age_rating, director, writers, actors, total_rating, poster, release: {date, release_country}, runtime, genre, description},
      ...
      <div class="film-details__info-wrap">
          ...
          <div class="film-details__info">
            ...
            <table class="film-details__table">
              ...
              <tr class="film-details__row">
                <td class="film-details__term"> ${genre && genre.filter(Boolean).length > 1 ? 'Genres' : 'Genre' }</td>
        ...
        <section class="film-details__controls">
          ...
          <button type="button" class="film-details__control-button film-details__control-button--watched ${makeButtonActive(already_watched)}" id="watched" name="watched">Already watched</button>
